...
export class Influencer {
  ...
  createSlides() {
    ...
    for (let j = 0; j < this.photos.length; j++) {
      ...
      _slides += `<div class="single-card--slide">
<div class="single-slide--image" style="background-image:url(${ photo });"></div></div>`;
    }
    return _slides;
  }
  ...
  load(opts) {
    // language=HTML
    return `<a role="button" tabindex="1" data-toggle="modal" data-target=".modal-single--influencer" class="d-block single-profile--card">
  <div class="single-card--title">
    <div class="row justify-content-between flex-nowrap align-items-center">
      <div class="col">
           <h5><b>${this.name}, ${this.age}</b></h5>
      </div>
      <div class="col-auto">
  ...
  <div class="single-card--owlwrapper">
    ...
    <button role="button" class="single-card--likebtn">
