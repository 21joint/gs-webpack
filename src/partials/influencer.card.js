  ...
  createCard() {
    return `<div class="single-profile--card">
        ...
        <div class="single-card--networks">
          <ul>
            <li>
              <i class="network-icon r-icon--social tumblr"></i> <span>45k</span>
            </li>
            <li>
              <i class="network-icon r-icon--social fb"></i> <span>45k</span>
            </li>
            <li>
              <i class="network-icon r-icon--social pinterest"></i> <span>45k</span>
            </li>
          </ul>
        </div>
      </div>`
