...
export class Influencer {
  ...
  createSlides() {
    ...
    for (let j = 0; j < this.photos.length; j++) {
      ...
      _slides += `<div class="single-card--slide"><a role="button" tabindex="1" data-toggle="modal" data-target=".modal-single--influencer"><div class="single-slide--image" style="background-image:url(${ photo });"></div></a></div>`;
    }
    return _slides;
  }
    ...
    return `<div class="single-profile--card">
              ...
              <div class="single-card--title">
                <div class="row justify-content-between flex-nowrap align-items-center">
                  <div class="col">
                    <a tabindex="1" data-toggle="modal" href=".modal-single--influencer">
                      <h5>
