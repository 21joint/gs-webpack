...
$(document).ready(function () {
    ...
    let $profileCarousel = $('.single-profile--carousel'),
        ...
        tabsCarousel = function () {
            ...
            $clonedTabsNav.appendTo($profileTabsNav.parent()).removeClass('py-3').addClass('py-4').addClass('owl-carousel d-md-none').find('[data-toggle="tab"]').each(function (i, el) {
            ...
            $clonedTabsNav.owlCarousel({
                ...
                console.log(e);
                var _targetId = $clonedTabsNav.find('.active.center .nav-link').attr('href'),
            ...
            $('.find-influencer--navtabs [data-toggle="tab"]').on('show.bs.tab', function (e) {
