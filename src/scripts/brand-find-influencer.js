  ...
  (function() {
    ...
    $(document)
      .on("show.bs.modal", ".modal-single--influencer", function(e) {
        let $thisCard = $(e.relatedTarget).closest(".single-profile--card");
      ...
      .on("shown.bs.tab", function(e) {
        $($(e.target).attr("href") + " .owl-carousel").resize();
      })
      ...
      .on("click", ".single-card--infobtn", function(e) {
        let _profile = $(e.currentTarget).parents(".single-profile--card"),
    ...
    $(document).on(
      ...
      function(e) {
        ...
        let $parent = $(e.target).closest("[class*=collapse-]");
