...
$(document).ready(function() {
  ...
  $('.search-filter--ul li').on('show.bs.dropdown', function(e) {
  ...
  rangeSliders().init('.gs-range--slider');

  $('.noUi-handle').on('mousedown touchstart click', function(e) {
    $(document).one('mouseup', function(e) {
      if (!$(e.target).parents('.dropdown-menu')) {
        $('.search-filter--ul li').one('hide.bs.dropdown', function() {
          e.stopPropagation();
        })
      }
    });
